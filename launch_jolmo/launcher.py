...
executor.stage("maxeig-tuned-bases", maxeig_tuned_bases)  # dependency only
executor.stage("maxeig-tuned-evals", maxeig_tuned_evals)
executor.stage_group("maxeig-tuned", ("maxeig-tuned-bases", "maxeig-tuned-evals"))
